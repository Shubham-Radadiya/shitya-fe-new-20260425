...
const Bills = ({ returnMode, setReturnMode }) => {
  ...
  return (
    <div className="bill-container">
      <div className="bills">
        <h3 className="bill-title" style={{ userSelect: "none", color:
                      currentLocation.pathname === "/stock" && "rgb(23 136 42)"}}>Bills</h3>

        <div className="Homebuttons">
          <button className={currentLocation.pathname === "/stock" ? "purchase_icon-button":"icon-button"}>
            <Link
              to="/report"
          ...
          <button
            className={currentLocation.pathname === "/stock" ? "purchase_icon-button":"icon-button"}
            onClick={() => {
              dispatch({ type: CLEAR_CART });
              setShowReprintBill(false);
              setShowPrintBill(false);
          ...
          <button className={currentLocation.pathname === "/stock" ? "purchase_icon-button":"icon-button"} onClick={handleReturnBill}>
            Return
          </button>
          {/* {items.length > 0 {}} */}
          ...
          <button className={currentLocation.pathname === "/stock" ? "purchase_icon-button":"icon-button"} onClick={openReprintModal}>
            Re Print
          </button>
        </div>
          ...
          {showReprintBill ? (
            <div className="table-container">
              <table className="bill_table">
                ...
                <tfoot>
                  <tr>
                    <td style={{ fontWeight: "bolder", textAlign: "start", width:"85px" }}>
                      Total
                    </td>
                    <td></td>
                    <td>
                    ...
                    <td style={{ fontWeight: "bolder", textAlign: "center", textWrap:"nowrap", overflow:"visible  ", textOverflow:"none" }}>
                      ₹{" "}
                      {returnMode ? "-" : null}
                        {new Intl.NumberFormat("en-IN").format(
                  ...
                  {items.length > 0 ? (
                    items.map((product) => (
                      <tr key={product._id}>
                        ...
                        <td
                          style={{ fontWeight: "bolder",padding: 0, textAlign: "center", textWrap:"nowrap", overflow:"visible  ", textOverflow:"none" }}
                        >
                          {returnMode ? "-" : null}
                          {new Intl.NumberFormat("en-IN").format(
                            product.price * product.quantity
                  ...
                  <tr>
                    ...
                    <td
                      style={{
                        ...
                        textAlign: "center",
                        width: "60px",
                        textWrap:"nowrap", overflow:"visible  ", textOverflow:"none" 
                      }}
                    >
                      {returnMode ? "-" : null}₹{" "}
